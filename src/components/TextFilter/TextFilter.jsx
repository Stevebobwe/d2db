...
function TextFilter() {
  ...
  const [byMaxstr, setByMaxstrFilter] = useState('');

  // Required Dexterity
  const [byMindex, setByMindexFilter] = useState(0);
  const [byMaxdex, setByMaxdexFilter] = useState('');
